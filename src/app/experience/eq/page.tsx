  ...
  return (
    <div className="relative z-10 h-2/3 w-2/3 border-2 border-mainorange">
      <div className="grid h-full w-full grid-cols-2 grid-rows-[12%_auto_20%] gap-6 px-12 py-12">
        ...
        >
          <Image src={eqImg} alt="uci" className="h-5/6 w-5/6 bg-white" />
        </div>
        <div
          id="experienceTitle"
        ...
        <ul
          id="experienceDesc"
          className="col-span-1 row-span-1 flex h-full w-full list-disc flex-col items-center gap-2 overflow-y-auto px-12 text-lg"
        >
          <li>
